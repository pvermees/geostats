...
\begin{minipage}[t][][t]{.75\textwidth}
  \captionof{figure}{PCA decomposition of
    ...
    principal direction, which runs perpendicular to it.\medskip}
  \label{fig:PCA2D1}
\end{minipage}
...
\begin{minipage}[t][][t]{.75\textwidth}
  \captionof{figure}{Projection of the three data points on the two
    ...
    representation of the two-dimensional data\medskip}
  \label{fig:PCA2D2}
\end{minipage}
...
\begin{minipage}[t][][t]{.75\textwidth}
  \captionof{figure}{A biplot of both principal components along with
    ...
    begin slightly richer in $a$ and $b$ than sample~2.\medskip}
  \label{fig:PCA2D3}
\end{minipage}
...
gradient search algorithm to minimise Equation~\ref{eq:stress}.\medskip
