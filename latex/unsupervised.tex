...
Before applying PCA to Table~\ref{tab:USArrests}, it is useful to
scale the variables to have the same variance. This ensures that they
are given equal weight in the analysis. Applying PCA to the scaled
data yields four principal components, the first two of which
represent 62\% and 25\% of the total variance, respectively.
Visualising the PCA results as a biplot:
