...
\noindent\begin{minipage}[t][][b]{.4\textwidth}
\includegraphics[width=\textwidth]{../figures/ACNKarithmeticmean.pdf}\\
\end{minipage}
\begin{minipage}[t][][t]{.6\textwidth}
  \captionof{figure}{ The black square represents the average A--CN--K
    ...
    example of Figure~\ref{fig:porositylocation}.a.\\}
...
\begin{minipage}[t][][t]{.6\textwidth}
  \captionof{figure}{The black polygon represents a `95\% confidence
    ...
    physically impossible negative data space.\\}
  \label{fig:ACNKnaive}
\end{minipage}
...
\begingroup \captionof{figure}{The additive logratio transformation
  ...
  (Equation~\ref{eq:inverse-logratio-transformation}).\\}
\label{fig:alr}\endgroup

The transformed arithmetic mean of the logratios equals the
...
\begin{minipage}[t][][t]{.7\textwidth}
  \captionof{figure}{Ternary diagram of the synthetic toy example of
    ...
    of samples 2 and 3, whose compositions are very similar.\\}
  \label{fig:abc}
\end{minipage}
...
\begin{minipage}[t][][t]{.7\textwidth}
  \captionof{figure}{Compositional biplot of the toy data using the
    ...
    biplot tells use that sample~1 is rich in component $a$, whereas
    samples~2 and 3 are rich in component $b$. The difference between
...
\noindent\begin{minipage}[t][][b]{.4\textwidth}
\includegraphics[width=\textwidth]{../figures/majorPCA.pdf}\\
\end{minipage}
\begin{minipage}[t][][t]{.6\textwidth}
  \captionof{figure}{Compositional biplot of the major element
    ...
    close together (such as N1 and N4) have similar compositions. The
    ...
    suggesting that these two oxides are correlated. The arrow for
    K\textsubscript{2}O points in the opposite direction, suggesting
    that this oxide anticorrelated with MgO and CaO.  The
    \textbf{link} between K\textsubscript{2}O and MgO is perpendicular
    to the link between TiO\textsubscript{2} and
    P\textsubscript{2}O\textsubscript{5}, suggesting that the
    variability of these two \textbf{subcompositions} is statistically
    independent.\\}
  \label{fig:majorPCA}
\end{minipage}
...
\begin{minipage}[t][][t]{.65\textwidth}
  \captionof{figure}{A dataset of igneous rock compositions from
    ...
    marking the calc-alkaline suite of rocks from the Cascades.  \\}
  \label{fig:AFM}
\end{minipage}
...
\noindent\begin{minipage}[t][][b]{.35\textwidth}
\includegraphics[width=\textwidth]{../figures/lrAFM.pdf}\\
\end{minipage}
\begin{minipage}[t][][t]{.65\textwidth}
  \captionof{figure}{The additive logratio transformation liberates
    ...
    any value from $-\infty$ to $+\infty$. In this space, the ln(M/A)
    vs. ln(F/A) values of the tholeiitic and calc-alkali rock suites
    are clustered into two discrete clouds of roughly equal size that
    ...
    suited for linear discriminant analysis.\\}
  \label{fig:lrAFM}
\end{minipage}
