...
\item A gemologist has ranked 15 diamonds in order of increasing
  ...
  Using Table~\ref{tab:w0.025} or \ref{tab:w0.05}, is there a
  statistically significant difference in quality between the two
  diamond varieties at a 95\% confidence level?
