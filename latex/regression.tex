...
geochronometer:
\begin{equation}
  \left[\frac{{}^{87}\mbox{Sr}}{{}^{86}\mbox{Sr}}\right] =
  \left[\frac{{}^{87}\mbox{Sr}}{{}^{86}\mbox{Sr}}\right]_\circ +
  \left[\frac{{}^{87}\mbox{Rb}}{{}^{86}\mbox{Sr}}\right]
  \left(e^{\lambda{t}}-1\right)
  \label{eq:Rb-Sr}
\end{equation}

\noindent where $t$ is the age of the system, in millions of years,
and $[{}^{87}\mbox{Sr}/{}^{86}\mbox{Sr}]_\circ$ is the non-radiogenic
...
\begin{center}
  \begin{tabular}{c|cccccccc}
    ...
    $[{}^{87}\mbox{Rb}/{}^{86}\mbox{Sr}] = x_i$ & 2.90 & 7.14 & 9.10 &
    3.41 & 1.91 & 7.15 & 5.92 & 8.28 \\
    $[{}^{87}\mbox{Sr}/{}^{86}\mbox{Sr}] = y_i$ & 0.745 & 0.803 & 0.823 & 0.737 &
