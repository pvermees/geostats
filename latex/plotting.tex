...
\begin{minipage}[t][][t]{.45\textwidth}
  \captionof{figure}{Rug plots of the pH data with a) a kernel
    bandwidth of $h=0.1$; and b) a bandwidth of $h=1$. Using a narrow
    bandwidth undermooths the data, whereas a wide bandwidth produces
    an oversmoothed distribution.}
\end{minipage}
...
\end{minipage}
\begin{minipage}[t][][t]{.7\textwidth}
  \captionof{figure}{Rug plot of 20 clast size measurements.  Even
    though all the measurements are strictly positive, the KDE extends
    into negative data space.}
...
\end{minipage}
\begin{minipage}[t][][t]{.7\textwidth}
  \captionof{figure}{Rug plot of 20 porosity measurements.  Even
    though all the measurements are between 0 and 1, the KDE extends
    beyond these hard limits.}
