...
\captionof{table}{Twenty imaginary river catchments have been analysed
  ...
  of natural springs in the catchments; the pH of the river water; the
  catchment area (in km\textsuperscript{2}); and the percentage of
  this area that is covered by vegetation.\medskip}
...
\begingroup \captionof{figure}{Three continuous datasets, shown as
  ...
  (free to take on positive and negative values); b) catchment area
  (non-negative numbers); and c) the proportion covered by vegetation
...
\begin{minipage}[t][][t]{.7\textwidth}
  \captionof{figure}{Using a Gaussian kernel instead of a rectangular
    ...
    with bandwidth $h=1$. This produces a smooth KDE.}
\end{minipage}
...
\end{minipage}
\begin{minipage}[t][][t]{.7\textwidth}
  \captionof{figure}{KDE of 20 catchment areas.  Even though all the
    measurements are strictly positive, the curve extends into
...
\end{minipage}
\begin{minipage}[t][][t]{.4\textwidth}
  \captionof{figure}{a) KDE of the catchment area measurements, after
...
\begingroup \captionof{figure}{Empirical cumulative distribution
  ...
  is shown in Figure~\ref{fig:pHgaussKDE}); b) the catchment areas of
