...
\begin{console}
> myframe2 <- read.csv(file='timescale.csv')
\end{console}
...
\item \texttt{R} contains not one but two built-in PCA functions:
  ...
  decomposition.}. Applying \texttt{princomp} to the US arrests data
  to produce the biplot shown in Figure~\ref{fig:USArrests}:
