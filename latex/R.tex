...
A KDE of the log-transformed catchment area data
...
> mean(catchments$pH)
[1] 5
> sd(catchments$pH) # standard deviation
[1] 0.6537342
> median(catchments$pH)
[1] 5.1
> mad(catchments$pH,constant=1) # median absolute deviation
[1] 0.5
> IQR(catchments$pH,type=1) # interquartile range
[1] 1
\end{console}
...
\begin{console}
> skew(catchments$area)
[1] 1.212305
\end{console}

\item A box plot for the catchment area data:

\begin{console}
boxplot(catchments$area)
\end{console}
...
\texttt{binom.test()} in a variable \texttt{h}. $H_\circ$
