...
\ref{sec:circular-distributions}. To average a collection of $n$
spherical measurements, we take their vector sum:
...
\begin{equation}
  \left\{
  \begin{split}
  \bar{L} & = \arccos\left({\bar{x}}/{\sqrt{1-\bar{y}^2}}\right)\\
...
\begin{equation}
  \left\{
  \begin{split}
    \bar{S} & = \arccos\left({\bar{x}}/{\sqrt{1-\bar{z}^2}}\right)\\
...
\begin{equation}
  \left\{
  \begin{split}
    \bar{D} & = \arccos\left({\bar{y}}/{\sqrt{1-\bar{z}^2}}\right)\\
...
\begin{equation}
  f(x,y,z|\mu_x,\mu_y,\mu_y,\kappa) =
  \frac{\kappa\exp[\kappa (x\mu_x+y\mu_y+z\mu_z)]}{2\pi(\exp[\kappa]-\exp[-\kappa])}
