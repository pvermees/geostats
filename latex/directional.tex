...
\begin{minipage}[t][][t]{.75\textwidth}
  \captionof{figure}{20 pebbles in a sedimentary bed are aligned in a
    ...
    points in a northwesterly direction.\medskip}
  \label{fig:pebbles}
\end{minipage}
...
A better average is again obtained by minimising the moment of
inertia, which is achieved by generalising
Equation~\ref{eq:sphericalsigma} from two to three dimensions and
subjecting the resulting covariance matrix to an eigendecomposition.
