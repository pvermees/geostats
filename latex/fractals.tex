...
catalog\footnote{https://earthquake.usgs.gov/earthquakes/search/} of
global earthquakes. Here is a histogram of the 20,000 most recent
earthquakes with magnitude 4.5 or greater, which was downloaded when
...
\begin{minipage}[t][][t]{.7\textwidth}
  \captionof{figure}{The same data as Figure~\ref{fig:loglogbritain}
    ...
    best fit line equals 1 + the slope of
    Figure~\ref{fig:loglogbritain}.}
...
changes in the obliquity of Mars has caused its polar ice caps to
shift over time.\\
