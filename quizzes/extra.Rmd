...
```{r summary-table, out.width="50%", out.height="50%", fig.width=5, fig.height=5}
nn <- length(ns)
...
```{r binomialtest5, out.width="50%", out.height="50%", fig.width=5, fig.height=5}
...
```{r binomialci2, out.width="50%", out.height="50%", fig.width=5, fig.height=5}
...
```{r binomialci3, out.width="50%", out.height="50%", fig.width=5, fig.height=5}
