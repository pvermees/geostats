...
1. Radioactive decay is the process whereby a _parent_ isotope $P$
...
the amount of parent and a _decay constant_ $\lambda_P$:
   ...
   par(mfrow=c(1,2))
   plot(x=tt,y=P,type='l',col='red',xlab='time',ylab='atoms')
   lines(x=tt,y=D,col='blue')
   legend('right',legend=c('P','D'),lty=1,col=col,text.col=col,bty='n')
