...
text(cos(pi/8)*0.7,sin(pi/8)*0.7,labels='atan(y/x)',pos=3,xpd=NA)
text(cos(pi/8)*0.7,sin(pi/8)*0.7,labels='= atan2(y,x)',pos=1,xpd=NA)
text(x3[50],y3[50],labels='atan(-y/x)',pos=2,xpd=NA)
